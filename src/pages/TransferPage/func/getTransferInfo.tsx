...
export async function getTransferInfo(currentDate: string, currentInterval: string[]) {
    const config = {
        method: 'get',
        url: `https://www.svo.aero/bitrix/timetable/?direction=transit&dateStart=${currentDate}T${currentInterval[0]}&dateEnd=${currentDate}T${currentInterval[1]}&perPage=9999&page=1&&locale=ru`,
    };
